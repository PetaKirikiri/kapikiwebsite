...
export default function KitchenGame({classRoom}:{classRoom?:string}){
 ...
 return <main ref={app} className={`kitchen-app ${joined?'is-playing':'is-lobby'}${classRoom?' kitchen-embedded':''}`}>
  <header className="kitchen-hud">
   <div className="kitchen-brand"><a className="kitchen-icon-button" href="#live-class" aria-label="Back to class"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true"><path d="m14 5-7 7 7 7" strokeLinecap="round" strokeLinejoin="round"/></svg></a><div><span>KA PIKI</span><strong>Kitchen</strong></div></div>
