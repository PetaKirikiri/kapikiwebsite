...
export type KitchenPlayer = Point & {motionId?:number;motion?:MotionInstruction[];path:Point[];startedAt:number;target:string|null;held:string|null;notice:string;commandId?:string;facing?:Point;walking?:boolean;interaction?:KitchenInteraction;lastActionId?:string;actionResults?:{id:string;held:string|null;notice:string;accepted?:boolean;station?:string;before?:string|null;at?:number}[]}
...
export type InteractionIntent = {station:string;held:string|null;result?:string|null;after?:string}
